const Content = () => {
  ...
  const bonus = {
    ...
    paragraphs: [
      <>
        I'd love to share a bit more about my background and interests outside
        of work. Aside from being passionate about web development, I'm also an
        avid woodworker. When I'm not coding, you'll probably find me in my
        workshop.
      </>,
      <>
        Woodworking is a big passion of mine—it's taught me patience, precision,
        and how to plan ahead. These skills come in handy when I'm working on
        web projects, helping me create well-thought-out and detailed
        applications. There's something incredibly satisfying about taking raw
        materials and transforming them into something both functional and
        beautiful. This hobby has taught me a lot about patience, precision, and
        the importance of planning ahead, which I find translates really well
        into my coding projects.
      </>,

      <>
        When I'm working on a coding project, I often think about it in the same
        way I do a woodworking piece. I envision the final product, plan out how
        all the parts will come together, and pay close attention to the details
        to ensure everything fits perfectly. This mindset helps me write clean,
        efficient code and design intuitive user interfaces.
      </>,

      <>
        Also, I believe in continuous learning and improvement, whether it's
        mastering a new framework in web development or learning a new
        woodworking technique. I'm always eager to take on new challenges and
        find innovative solutions, which keeps me motivated and engaged in my
        work.
      </>,

      <>
        So, while my resume covers my professional qualifications, I think these
        personal interests and values really highlight who I am and how I
        approach my work.
      </>
    ]
  }
  ...
  const aboutMe = {
    ...
    aboutMeTopics: [
      {
        'Hey There!':
          "I'm TJ Loughry, a Web Developer and Automation Testing Support Engineer based in Austin, Texas. I love creating user-friendly web applications and solving tricky tech problems."
      },
      {
        'What I Do':
          "At SubjectWell, I've tackled a ton of website issues, helped move our database to AWS, and made sure everything runs smoothly by keeping an eye on our Step and Lambda functions. Before that, at Sauce Labs, I helped customers with their Selenium/Appium testing, wrote helpful documentation, and managed the support queue. I even took on the role of Austin Office Lead/Manager, where I helped set up our office space and organized team events."
      },
      {
        'My Skills':
          "I'm skilled in HTML, CSS, JavaScript, React, Node.js, Express, MongoDB, Python, Selenium, Appium, Vue.js, and Rails. I've got a knack for reviewing code, fixing issues, and making databases work better."
      },
      {
        'My Background':
          'I studied Accounting at Midwestern State University and obtained an Associate of Science in Mathematics from Austin Community College. I also completed a Web Development Immersive program at General Assembly in Austin.'
      }
    ]
  }
    ...
    institutions: [
      {
        ...
        details:
          'Completed an intensive, hands-on program focused on full-stack web development, covering HTML, CSS, JavaScript, React, Node.js, and more.',
...

      {
        ...
        details:
          "Gained a comprehensive understanding of business principles and accounting practices, developing analytical and problem-solving skills. Obtained Dean's List Honors for all semesters.",
      ...
      },
      {
        ...
        details:
          'Studied international business strategies and practices, gaining insights into global markets and cross-cultural communication.',
      ...
      },
      {
        ...
        details:
          'Developed a strong foundation in mathematical principles and problem-solving techniques, which are integral to my technical skills in software development.',
